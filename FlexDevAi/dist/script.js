...
const translations= {
  fr: {
    ...
    "hero__note": "Paiement unique, maintenance offerte.",
    ...
    "about__eyebrow": "01 / À PROPOS DE MOI",
    "about__title": "Un partenaire pour<br>faire avancer votre web.",
    "about__p1": "En cours de graduat en programmation, je suis passionné de développement web depuis mon plus jeune âge. C’était une évidence : j’ai toujours su que c’était ce que je voulais faire, et j’ai commencé à coder dès que possible.",
    ...
    "b7__title": "Paiement unique, maintenance offerte",
    "b7__desc": "Un seul paiement, sans abonnement. Entretien et corrections inclus pendant les premiers mois.",
    ...
    "contact__p": "Un nouveau site, un bug tenace ou une idée à concrétiser ?<br>Racontez-moi ce dont vous avez besoin.<br><br>Aucun engagement — ces informations sont purement indicatives.",
  ...
  en: {
    ...
    "hero__note": "One-time payment, maintenance included.",
    ...
    "about__eyebrow": "01 / ABOUT ME",
    "about__title": "A partner to keep<br>your web moving forward.",
    "about__p1": "Working towards a degree in programming, I have been passionate about web development since I was young. It was obvious from the start: I always knew this was what I wanted to do, and I started coding as soon as I could.",
    ...
    "b7__title": "One-time payment, maintenance included",
    "b7__desc": "A single payment, no subscription. Care and fixes included for the first months.",
    ...
    "contact__p": "A new website, a stubborn bug or an idea to bring to life?<br>Tell me what you need.<br><br>No commitment — this information is for guidance only.",
  ...
  nl: {
    ...
    "hero__note": "Eénmalig betalen, onderhoud inbegrepen.",
    ...
    "about__p1": "Met een graduat programmeren in de maak, ben ik al van kinds af aan gepassioneerd door webontwikkeling. Het was meteen duidelijk: ik wist altijd al dat ik dit wilde doen, en ik begon zo vroeg mogelijk met coderen.",
    ...
    "b7__title": "Eénmalig betalen, onderhoud inbegrepen",
    "b7__desc": "Eén betaling, zonder abonnement. Onderhoud en correcties inbegrepen tijdens de eerste maanden.",
    ...
    "contact__p": "Een nieuwe website, een hardnekkige bug of een idee dat je wilt realiseren?<br>Vertel me wat je nodig hebt.<br><br>Geen verplichting — deze gegevens zijn louter indicatief.",
